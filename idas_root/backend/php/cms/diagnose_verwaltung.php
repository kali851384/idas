...
<div class="layout">
  <aside class="sidebar">
    ...
    <nav>
      ...
      <a class="nav-link active" href="diagnose_verwaltung.php"><span class="icon">🏥</span> Diagnosen</a>
...
<div class="topbar">
  <div class="page-header"><div><div class="page-title">🏥 Diagnosen</div></div></div>
...
<div class="toolbar">
    ...
    <?php if ($search || $filterPat): ?>
      <a href="diagnose_verwaltung.php" class="nav-link active" class="btn ghost">✕</a>
    <?php endif; ?>
