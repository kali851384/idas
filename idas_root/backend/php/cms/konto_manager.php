...
<div class="layout">
  <aside class="sidebar">
    ...
    <nav>
      ...
      <a class="nav-link active" href="konto_verwaltung.php"><span class="icon">🔐</span> Konten</a>
    </nav>
...
<div class="page-header"><div><div class="page-title">🔐 Konto-Verwaltung</div></div></div>
<?php if ($msg): ?>
