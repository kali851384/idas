...
<div class="layout">
  <aside class="sidebar">
    ...
    <nav>
      ...
      <a class="nav-link active" href="kontakt_verwaltung.php"><span class="icon">✉️</span> Nachrichten</a>
...
<div class="topbar">
  <div class="page-header"><div><div class="page-title">✉️ Kontakt-Nachrichten</div></div></div>
...
<div class="form-box">
  ...
  <form method="post">
    ...
    <a href="kontakt_verwaltung.php" class="nav-link active" class="btn ghost" style="margin-left:8px">Abbrechen</a>
  </form>
</div>
<?php endif; ?>
