...
<div class="layout">
  <aside class="sidebar">
    ...
    <nav>
      ...
      <a class="nav-link active" href="support_verwaltung.php"><span class="icon">🎧</span> Support</a>
...
<div class="topbar">
  <div class="page-header"><div><div class="page-title">🎫 Support-Tickets</div></div></div>
...
<div class="toolbar">
  ...
  <?php if ($search || $filterStatus): ?>
    <a href="support_verwaltung.php" class="nav-link active" class="btn ghost">✕ Zurücksetzen</a>
  <?php endif; ?>
