...
<div class="layout">
  <aside class="sidebar">
    ...
    <nav>
      ...
      <a class="nav-link active" href="patienten_verwaltung.php"><span class="icon">👤</span> Patienten</a>
...
<div class="topbar">
  <div class="page-header"><div><div class="page-title">👤 Patienten verwalten</div></div></div>
...
<div class="toolbar">
  <form class="search-form" method="get">
    ...
    <?php if ($search): ?><a href="patienten_verwaltung.php" class="nav-link active" class="btn ghost">✕</a><?php endif; ?>
  </form>
